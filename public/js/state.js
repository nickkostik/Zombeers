import * as UI from './ui.js'; // Import UI for notifications
...
export function saveState() {
    try {
        ...
        UI.showNotification("Could not save game state. Local storage might be full or disabled.", 'error', 5000); // Longer duration
    }
}
...
export function resetFullState() {
     ...
     // Or full reset:
     gameState = {
        roomCode: gameState.roomCode, // Keep room code
        gameActive: false,
        players: [],
